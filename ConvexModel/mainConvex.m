% mainConvex
addpath ../CSTR/ ../OtherFunctions/ ../PlotFunctions/

% opt
[u_opt, phi_opt] = fmincon(@(x)phiFun(x,openModel(x)),[4, 10, 80], ...
    [],[],[],[],[0,0,70],[20,50,120],@(x)(conFun(x,openModel(x))));
X_opt = openModel(u_opt);
